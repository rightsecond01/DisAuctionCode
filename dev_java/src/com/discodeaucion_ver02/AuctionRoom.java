...
public class AuctionRoom extends JPanel implements ActionListener {
	...
	JPanel jp_left_Bottom_other_Search       = new JPanel();
	...
	/////버튼 세팅 끝////
		...
		jp_left_Main_Talk.add("Center", jsp_display);
		...
		jp_left_Bottom_other_Search.setLayout(new BorderLayout());
		jp_left_Bottom_other_Search.add("Center", new JTextArea());
		/////////채팅라벨세팅/////////
		...
		jp_left_Bottom_other.add(jp_left_Bottom_other_Search,
